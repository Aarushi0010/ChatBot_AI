...
def main(page : ft.Page):
    ...
    # tell user to wait for response 
    page.pubsub.send_all(Message(user_name = "ChatGPT", text = "We are generating the response " , message_type = "login_message"))


    Chatgpt = ChatGPT()
    new_message =""
    ai_response = Chatgpt.ChatGPTResponse(user_text=str(new_message))
    page.pubsub.send_all(Message("ChatGPT", str(ai_response).lstrip() , message_type = "chat_message"))
